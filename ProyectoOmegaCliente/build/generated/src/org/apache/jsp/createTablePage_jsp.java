...
public final class createTablePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <br>\n");
      out.write("        <label id=\"hello\"> How many fields </label>\n");
      out.write("        <br>\n");
      ...
      out.write("            <thead>\n");
      out.write("                <tr>\n");
      out.write("                    <th>Field_Name</th>\n");
      out.write("                    <th>Type</th>\n");
      out.write("                    <th>Primary_Key</th>\n");
      out.write("                    <th>Unique</th>\n");
      out.write("                    <th>Not_Null</th>\n");
      out.write("                </tr>\n");
      out.write("            </thead>\n");
      out.write("            <tbody>\n");
      out.write("\n");
      ...
      out.write("        \n");
      out.write("        <script>\n");
      out.write("            var tabla = document.getElementById('table_data');\n");
      out.write("          //  document.getElementById('field_name').innerHTML = \"alo\";\n");
      out.write("            //var txtField_name = document.getElementById('field_name').innerHTML;\n");
      out.write("            var number_fields = document.getElementById('number_fields').innerHTML;\n");
      out.write("            var ddlType = document.getElementById('type').innerHTML;\n");
      out.write("            var btnAdd = document.getElementById('add_value').innerHTML;\n");
      out.write("            var btnRm = document.getElementById('remove_value').innerHTML;\n");
      out.write("            var primary_key = document.getElementById('primary_key').innerHTML;\n");
      out.write("            var unique = document.getElementById('unique').innerHTML;\n");
      out.write("            var not_null = document.getElementById('not_null').innerHTML;\n");
      out.write("            var datos = [];\n");
      out.write("          \n");
      out.write("    \n");
      out.write("           function btnAdd_Click(id) {\n");
      out.write("               document.getElementById(id).setText(\"alo\");}\n");
      out.write("                 \n");
      ...
      out.write("                unique: unique,\n");
      out.write("                not_null: not_null\n");
      out.write("                 };\n");
      out.write("\n");
      ...
      out.write("            \n");
      out.write("        </script>\n");
      out.write("       <input type=\"submit\" value=\"add file\" id=\"field_name_btn\" onclick =\"btnAdd_Click('field_name')\" />\n");
      out.write("        \n");
      out.write("        \n");
      out.write("        \n");
      out.write("        \n");
